...
{
    public static DanceListStatus Unknown { get; } = new(0, 0, DanceListOrigin.BuiltIn, null);
}

public enum DanceListOrigin
{
    /// <summary>The copy shipped with the application, used until a download succeeds.</summary>
    BuiltIn,
