...
public sealed class EditorHistoryService(ILoggerService loggerService) : IEditorHistoryService, IDisposable
{
    ...
    public async Task<EditorActionResult> DoActionAsync(IEditorAction editorAction)
    {
        ...
        _ = loggerService.DebugAsync($"EditorHistory: Did '{editorAction.Description}'");
        return result;
    }
    ...
    public async Task UndoAsync()
    {
        ...
        _ = loggerService.DebugAsync($"EditorHistory: Undid '{editorAction.Description}'");
    }
    ...
    public async Task RedoAsync()
    {
        ...
        _ = loggerService.DebugAsync($"EditorHistory: Redid '{editorAction.Description}'");
    }
